%% run_online_policy_oamp_oampnet_paper_tsv2seq_vdop_ctrl.m
% Formal BER-SNR online rollout for the strong dynamic-control paper profile.
...
% Keep the paper wrapper aligned with the current 20-D policy export
